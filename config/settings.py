...
# SECRET_KEY = 'django-insecure-d*&r&n(9w1sxv3)09w8v^vv(@^xv-7-3g71ve1cbhr0h)2awy-'
...
# اگر خواستی کلید encryption جدا داشته باشی.
# اگر خالی باشد، از SECRET_KEY deriviation گرفته می‌شود.
